...
# 	template_name = "instantdesenv/tela_proposta.html"
...
# 		return render(request, 'instantdesenv/tela_2_proposta.html', context)
	

# class relatorioView(FormView, TemplateView):

# 	template_name = "instantdesenv/relatorio_0.html"
...
# 		for i in r1:
# 			if i == vetor:
# 				return 'instantdesenv/Relatorio.html'
# 		for i in r2:
# 			if i == vetor:
# 				return 'instantdesenv/Relatorio_1.html'
# 		for i in r3:
# 			if i == vetor:
# 				return 'instantdesenv/Relatorio_2.html'
# 		for i in r4:
# 			if i == vetor:
# 				return 'instantdesenv/Relatorio_3.html'
# 		for i in r5:
# 			if i == vetor:
# 				return 'instantdesenv/Relatorio_4.html'
...
# 	template_name = "instantdesenv/NovoUsuarioLogin.html"
...
# 	template_name = "instantdesenv/cadastro_clausulas.html"
...
# 	template_name = "instantdesenv/cria_contrato.html"
